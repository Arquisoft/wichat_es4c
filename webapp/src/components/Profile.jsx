            ...
            <CardContent>
              ...
              <Grid container spacing={3}>
                <Grid item xs={12} md={6}>
                  ...
                  <Typography variant="h6" sx={{ fontFamily: "Roboto, sans-serif" }} data-testid="games-played">
                    {user.gamesPlayed}
                  </Typography>
                ...
                <Grid item xs={12} md={6}>
                  ...
                  <Typography variant="h6" sx={{ fontFamily: "Roboto, sans-serif" }} data-testid="correct-answers">
                    {user.correctAnswers}
                  </Typography>
                ...
                <Grid item xs={12} md={6}>
                  ...
                  <Typography variant="h6" sx={{ fontFamily: "Roboto, sans-serif" }} data-testid="wrong-answers">
                    {user.wrongAnswers}
                  </Typography>
                ...
                <Grid item xs={12} md={6}>
                  ...
                  <Typography variant="h6" sx={{ fontFamily: "Roboto, sans-serif" }} data-testid="total-time">
                    {user.totalTimePlayed} seg
                  </Typography>
